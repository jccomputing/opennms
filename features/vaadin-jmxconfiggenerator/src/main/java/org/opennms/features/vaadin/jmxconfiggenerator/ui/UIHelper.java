...
public abstract class UIHelper {
	...
	public static String loadContentFromFile(final Class<?> clazz, final String resourceName) {
		...
		try (InputStream is = clazz.getResourceAsStream(resourceName);
			...
			// TODO MVR what do we do here? We should propagade the exception accordingly
	...
	public static <T> void validateFields(Collection<Field<T>> fields, boolean swallowValidationExceptions) {
