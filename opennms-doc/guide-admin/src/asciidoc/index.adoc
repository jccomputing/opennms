...
include::text/enlinkd/lldp-discovery.adoc[]
include::text/enlinkd/cdp-discovery.adoc[]
include::text/enlinkd/bridge-discovery.adoc[]

// Layer 3 Link Discovery
include::text/enlinkd/layer-3-discovery.adoc[]
include::text/enlinkd/ospf-discovery.adoc[]
include::text/enlinkd/is-is-discovery.adoc[]
